...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    for i in range(1, 11):
        ...
        if max_avg < tmp: 
            choose_num = i
            max_avg = tmp
        print("DEBUG: current_avg = ", tmp),
        print("DEBUG: max_avg = ", max_avg)
        print("DEBUG: choose_num = ", choose_num)
    return choose_num
    # END PROBLEM 9
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    tmp = boar_brawl(score, opponent_score)
    if tmp >= threshold:
        return 0
    else:
        return num_rolls
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    tmp = sus_update(0, score, opponent_score) - score
    if tmp >= threshold:
        return 0
    else:
        return num_rolls
